...
data = pd.read_csv('historical_automobile_sales_1.csv')
...
app.layout = html.Div([
    ...
    style={ "textAlign": "left",'color': '#503D36','textAlign': 'center', 'font-size': 24}),#May include style for title
...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart1 = dcc.Graph(figure=px.scatter(yearly_rec, x='Year', y='Automobile_Sales',title="Automobile sales fluctuate over Recession Period"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        average_un = recession_data.groupby('Vehicle_Type')['unemployment_rate'].mean().reset_index()                           
        R_chart4  = dcc.Graph(figure=px.bar(average_un, x="Vehicle_Type", y="unemployment_rate",  title=' effect of unemployment rate on vehicle type')) 
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas,  x='Month',
                y='Automobile_Sales',title='Yearly Automobile sales' ))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        mas= yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()  
        Y_chart2 = dcc.Graph(figure=px.line(mas,  x='Month',
                y='Automobile_Sales',title='Total Monthly Automobile sales'))
            # Plot bar chart for average number of vehicles sold during the given year
        Y_chart3 = dcc.Graph(figure=px.bar(yas,  x='Month',
                y='Automobile_Sales',
